...
contract Hatch is IHatch, EtherTokenConstant, IsContract, AragonApp {
    ...
    */
    ...
    string private constant ERROR_INVALID_GOAL             = "HATCH_INVALID_GOAL";
    ...
    enum State {
        ...
        Refunding,   // hatch has not reached goal within period and contributors can claim refunds
        GoalReached, // hatch has reached goal within period and trading is ready to be open
        Closed       // hatch has reached goal within period, has been closed and trading has been open
    }
     ...
     * @param _goal                     The goal to be reached by the end of that hatch [in contribution token wei]
